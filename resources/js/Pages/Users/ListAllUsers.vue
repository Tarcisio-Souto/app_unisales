  ...
  <layout>
    ...
    <b-container fluid>
      ...
      >
        ...
        <template #cell(us_id)="row">
          <Link :href="'/usuario/visualizar/' + row.value"
            ><i class="fas fa-eye"></i
          ></Link>
          <Link :href="'/usuario/editar/' + row.value"
...
export default {
  ...
  methods: {
    ...
    cadDepartment() {
      axios.post("/usuario/registrar", this.form).then(
        function (res) {
          if (res.data["success"]) {
            bootbox.alert({
              centerVertical: true,
    ...
    delUser(id) {
      ...
      bootbox.confirm({
        ...
        callback: function (result) {
          if (result == true) {
            axios.post("/usuario/deletar/" + id).then(
              function (res) {
                if (res.data["success"]) {
                  bootbox.alert({
                    centerVertical: true,
